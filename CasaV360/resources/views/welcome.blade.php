...
@section('content')
    ...
    <div class="feature__content container container--pall">
        ...
        <div class="feature__grid">
          ...
          <div class="feature__item">
            <div class="feature__icon"><img src="{{ url('images/icon-online.svg') }}" /></div>
          ...
          <div class="feature__item">
            <div class="feature__icon"><img src="{{ url('images/icon-budgeting.svg') }}" /></div>
            <div class="feature__title">
              Simple Budgeting
            </div>
            <div class="feature__description">
          ...
          <div class="feature__item">
            <div class="feature__icon"><img src="{{ url('images/icon-onboarding.svg') }}" /></div>
            <div class="feature__title">
              Fast Onboarding
            </div>
            <div class="feature__description">
          ...
          <div class="feature__item">
            <div class="feature__icon"><img src="{{ url('images/icon-api.svg') }}" /></div>
            <div class="feature__title">
              Open API
            </div>
            <div class="feature__description">
  ...
  <div class="article__content container container--pall">
    ...
    <h2>Exemple de visite 360</h2>

    <div class="article__grid">

      <div class="article__item">
        <div class="article__image">
          <iframe width='100%' height='450em' frameborder=0 allowfullscreen src='https://my.matterport.com/show/?m=uRGXgoiYk9f&help=1'></iframe>
        </div>
      <div class="article__text">
        <div class="article__author">By A & O</div>
